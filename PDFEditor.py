...
class PreferencesManager:
    ...
    def __init__(self, filepath="preferences.txt"):
        ...
        self.defaults = {
            ...
            'color_detect_threshold': '10',
            'color_detect_samples': '100',
            'color_detect_scale': '0.5',
        }
...
class PreferencesDialog(tk.Toplevel):
    ...
    def build_ui(self):
        ...
        ttk.Label(color_detect_frame, text="(1-255, domyślnie 10)", foreground="gray").grid(row=0, column=2, sticky="w", padx=4, pady=4)
        ...
        ttk.Label(color_detect_frame, text="(10-1000, domyślnie 100)", foreground="gray").grid(row=1, column=2, sticky="w", padx=4, pady=4)
        ...
        ttk.Label(color_detect_frame, text="(0.1-2.0, domyślnie 0.5)", foreground="gray").grid(row=2, column=2, sticky="w", padx=4, pady=4)
